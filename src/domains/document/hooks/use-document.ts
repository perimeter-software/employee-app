...
export function useCreateDocument() {
    ...
    return useMutation({
        ...
        onSuccess: (newDoc: Document) => {
            ...
            console.log("✅ Document created and cached:", newDoc);
        },
        onError: (error) => {
...
export function useUpdateDocument() {
    ...
    return useMutation({
        ...
        onSuccess: (updatedDoc, { id }) => {
            ...
            console.log("✅ Document updated and cached:", updatedDoc);
        },
        onError: (error) => {
...
export function useDeleteDocument() {
    ...
    return useMutation({
        ...
        onSuccess: (_, deletedId) => {
            ...
            console.log("✅ Document deleted and removed from cache:", deletedId);
        },
        onError: (error) => {
