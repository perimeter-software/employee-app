...
export const ptoQueryKeys = {
  all: ['ptos'] as const,
  list: () => [...ptoQueryKeys.all, 'list'] as const,
  detail: (id: string) => [...ptoQueryKeys.all, 'detail', id] as const,
} as const;

export class PTOService {
  static listPTOs(): unknown {
   ...
   */
  static async createPTO(
    data: Omit<Timesheet, '_id' | 'createdAt' | 'updatedAt'>
  ): Promise<Timesheet> {
    try {
